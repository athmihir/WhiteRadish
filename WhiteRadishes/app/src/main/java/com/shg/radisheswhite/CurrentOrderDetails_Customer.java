...
public class CurrentOrderDetails_Customer extends AppCompatActivity {
    ...
    public class Item9{
        ...
        public Item9(String pname, String qtyval, String priceval) {
            this.pname = pname;
            this.qtyval = qtyval;
    ...
    class ItemAdapter9 extends BaseAdapter {

        private List<Item9> itemdata2 = new ArrayList<>();
        void setData(List<Item9> mData){
            itemdata2.clear();
        ...
        public View getView(int position, View convertView2, ViewGroup parent){
            ...
            Item9 currentItem = itemdata2.get(position);
    ...
    private ItemAdapter9 mAdapter2;
    private ArrayList<Item9> ItemsList2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_order_details__customer);

        //************************************CODFarmer page***********************************************
        //Listview2 is pointing to the listview we created
        listView2 = (ListView) findViewById(R.id.itemlist9);
        ...
        TextView expecteddelivery = findViewById(R.id.expecteddelivery);
        ...
        ImageView cancelbutton = findViewById(R.id.cancel_order);
        //Show top data
        ...
        freference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>(){
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot){
                if(documentSnapshot.exists()){
                    ...
                    expecteddelivery.setText(documentSnapshot.get("deliver_before").toString());
                    ...
                    Toast.makeText(CurrentOrderDetails_Customer.this, "Error displaying order.", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    for (QueryDocumentSnapshot snapshot: task.getResult()){
                        ...
                        ItemsList2.add(new Item9(name, quantity, price));
                    }
                    mAdapter2 = new ItemAdapter9();
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CurrentOrderDetails_Customer.this, UserOrders.class));
            }
        });
        //cancel order
            ...
            public void onClick(View v) {
                ...
                freference3.delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(CurrentOrderDetails_Customer.this, "Order cancelled successfully!", Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(CurrentOrderDetails_Customer.this, UserOrders.class));
                        }
                    }
                });
