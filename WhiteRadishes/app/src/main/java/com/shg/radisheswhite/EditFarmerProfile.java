...
public class EditFarmerProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_farmer_profile);
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(EditFarmerProfile.this, FarmerProfile.class));
            }
        });
        ...
        editbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DocumentReference freference = FirebaseFirestore.getInstance().document("Farmer/"+userid );
                ...
                freference.set(hashMap, SetOptions.merge()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            Toast.makeText(EditFarmerProfile.this, "Profile Updated Successfully!", Toast.LENGTH_SHORT).show();
                            finish();
                            startActivity(new Intent(EditFarmerProfile.this, FarmerProfile.class));
                        }
                        else{
                            Toast.makeText(EditFarmerProfile.this, "Error updating profile, Please try again!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
